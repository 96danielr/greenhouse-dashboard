  ...
  export const generateMockData = () => {
    return {
      ...
      sensors: {
        ...
        centralColumnStats: [
          `${faker.number.int({ min: 100, max: 500 })}x`, // Meteo
          `${faker.number.int({ min: 100, max: 500 })}x`, // Irrigation Unit
          `${faker.number.int({ min: 100, max: 500 })}x`, // Inputs
          `${faker.number.int({ min: 100, max: 500 })}x`, // Events
        ],
        waterHeat: {
          name: "Water Heat",
